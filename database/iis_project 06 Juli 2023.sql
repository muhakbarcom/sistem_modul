...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 06, 2023 at 05:08 PM
...
(17, 16, 5, 26, 4, 'Aplikasi.pdf', 'https://www.youtube.com/watch?v=Oextk-If8HQ&list=RDj_MlBCb9-m8&index=7&ab_channel=KeaneVEVO', 0, '2023-07-05 10:32:15');
...
CREATE TABLE `mentoring` (
  ...
  `id_internship_program_mahasiswa` int(11) DEFAULT NULL,
...
--
ALTER TABLE `mentoring`
  MODIFY `mentoring_id` int(11) NOT NULL AUTO_INCREMENT;
