...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 26, 2023 at 05:59 AM
...
(18, 16, 8, 24, 3, 'Coba_Dummy_(PDF)2.pdf', 'https://www.youtube.com/watch?v=WTJSt4wP2ME&list=RDE0z_TXMNc6Q&index=28', NULL, '2023-07-10 15:51:12'),
(19, 17, 8, 24, 3, 'cv.docx', 'https://youtu.be/kVgy1GSDHG8', NULL, '2023-07-11 22:19:05'),
(20, 10, 8, 28, 3, 'Coba_Dummy_(PDF)3.pdf', 'https://www.youtube.com/watch?v=DNEOkhw-mz4&list=RDDNEOkhw-mz4&start_radio=1', NULL, '2023-07-25 09:41:29');
...
CREATE TABLE `internship_program_mahasiswa_detail` (
  ...
  `status` int(11) NOT NULL COMMENT '1 = default\r\n2 = diterima\r\n0 = ditolak'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
(40, 18, 0, '2023-07-10', 1),
(41, 18, 1, '2023-07-10', 1),
(42, 18, 2, '2023-07-10', 1),
(43, 18, 3, '2023-07-10', 1),
(44, 19, 0, '2023-07-11', 1),
(45, 19, 1, '2023-07-11', 1),
(46, 19, 2, '2023-07-11', 1),
(47, 19, 3, '2023-07-11', 1),
(48, 20, 0, '2023-07-25', 1),
(49, 20, 1, '2023-07-25', 1),
(50, 20, 2, '2023-07-25', 1),
(51, 20, 3, '2023-07-25', 1);
...
(14, 12, 24, '2023-07-11 20:41:13', 'selamat pagi');
...
(10, 33, 'asdas', '2023-07-09 10:00:06', 1, 'Coba_Dummy_PDF_-_Copxys3.pdf'),
(11, 33, 'xxx', '2023-07-09 10:01:51', 1, 'Coba_Dummy_(PDF)7.pdf'),
(12, 33, 'xx', '2023-07-09 10:02:36', 1, 'Coba_Dummy_PDF_-_Copxys4.pdf');
...
(8, 19, 2, 121, 'fas fa-bars', 'Menu', 'cms/menu/side-menu', 'navMenu', 1),
(43, 14, 1, 0, 'fas fa-user', 'Manage Users', 'users', '1', 1),
(44, 15, 1, 0, 'fas fa-users-cog', 'Manage Roles', 'groups', '2', 1),
(89, 21, 2, 121, 'fas fa-th-list', 'Menu Type', 'menu_type', 'menu_type', 1),
(109, 18, 2, 121, 'fas fa-align-justify', 'Frontend Menu', 'frontend_menu', 'Frontend Menu', 1),
(121, 17, 1, 0, 'fab fa-apper', 'Hidden Menu', '#', '#', 1),
(123, 12, 2, 133, 'fas fa-calendar-alt', 'Internship', 'kelola_internship', 'kelola_internship', 1),
(124, 10, 2, 133, 'fas fa-book', 'Laporan', 'LaporanAkhir', 'kelola_laporan', 1),
(125, 11, 2, 133, 'fas fa-pencil-alt', 'Penilaian', 'Penilaian', 'kelola_penilaian', 1),
(127, 4, 1, 0, 'fas fa-user-friends', 'Mentoring', 'mentoring', 'mentoring', 1),
(130, 3, 1, 0, 'fas fa-user-check', 'Internship Role', 'internship_role', 'internship_role', 1),
(131, 5, 1, 0, 'fas fa-box-open', 'Internship Saya', 'internship_saya', 'internship_saya', 1),
(133, 7, 1, 0, 'fas fa-cog', 'Kelola', '#', '#', 1),
(134, 16, 1, 0, 'fas fa-cog', 'Setting Aplikasi', 'Setting', 'Setting', 1),
(135, 9, 2, 133, 'fas fa-database', 'Internship Roles', 'internship_role', 'internship_role', 1),
(136, 8, 2, 133, 'far fa-calendar-alt', 'Internship Program', 'internship_program', 'internship_program', 1),
(137, 1, 1, 0, 'fas fa-pencil-alt', 'Penilaian', 'Penilaian', 'Penilaian', 1),
(138, 2, 1, 0, 'fas fa-save', 'List Laporan Akhir', 'LaporanAkhir', 'LaporanAkhir', 1),
(139, 6, 1, 0, 'fas fa-list', 'Review Peserta', 'review_peserta', 'review_peserta', 1),
(140, 13, 1, 0, 'fas fa-chart-bar', 'Laporan Program', 'laporan_program', 'laporan_program', 1),
(141, 1, 2, 133, 'fab fa-500px', 'Kriteria Penilaian', 'Penilaian_kriteria', 'Penilaian_kriteria', 1);
...
INSERT INTO `penilaian_kriteria` (`id`, `kriteria`) VALUES
(1, 'Integritas'),
(2, 'Ketepatan Waktu');
...
CREATE TABLE `penilaian_nilai` (
  `id` int(11) NOT NULL,
  `id_intership_program_mahasiswa` int(11) NOT NULL,
  `id_kriteria` int(11) NOT NULL,
  `nilai` int(11) NOT NULL DEFAULT 0
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Dumping data for table `penilaian_nilai`
--

INSERT INTO `penilaian_nilai` (`id`, `id_intership_program_mahasiswa`, `id_kriteria`, `nilai`) VALUES
(1, 15, 1, 90),
(2, 15, 2, 100);
