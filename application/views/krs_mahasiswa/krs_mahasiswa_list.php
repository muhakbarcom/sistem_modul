    ...
    $(document).ready(function() {
        ...
        var t = $("#mytable").DataTable({
            ...
            columns: [{
                ...
                {
                    render: function(data, type, row) {
                        return `<button type="button" onclick="setMatkul(${row.id},${row.id_krs})" class="btn btn-sm btn-primary">Set Matkul</button>`;
                    }
                }
            ],
            columnDefs: [{
