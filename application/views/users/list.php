              ...
              <tbody>
                <?php foreach ($users as $user) : ?>
                  <tr>
                    ...
                    <td>
                      <?php echo anchor("users/read/" . $user->id, '<i class="fa fa-search-plus"></i>', 'class="btn btn-primary btn-xs" data-toogle="tooltip" title="Detail User"');
                      echo " ";
                      ...
                      echo " ";
                      echo anchor('users/delete/' . $user->id, '<i class="fa fa-trash"></i>', 'class="btn btn-xs btn-danger" onclick="return confirmdelete(\'users/delete/' . $user->id . '\')" data-toggle="tooltip" title="Delete"'); ?>
                    </td>
                  </tr>
                <?php endforeach; ?>
              </tbody>
