...
class Auth extends CI_Controller
{
	...
	public function change_password()
	{
		...
		if ($this->form_validation->run() === FALSE) {
			...
			$this->data['page'] = $this->config->item('template') . 'Auth/change_password';
			$this->load->view($this->config->item('template') . 'template/Backend', $this->data);
		} else {
	...
	public function deactivate($id = NULL)
	{
		...
		if ($this->form_validation->run() === FALSE) {
			...
			$this->data['page'] =  $this->config->item('template') . 'auth/deactivate_user';
			$this->load->view($this->config->item('template') . 'template/backend', $this->data);
	...
	public function create_user()
	{
		...
		if ($this->form_validation->run() === TRUE && $this->ion_auth->register($identity, $password, $email, $additional_data, $hak_akses)) {
			...
			$this->data['page'] = $this->config->item('template') . 'auth/create_user';
			$this->load->view($this->config->item('template') . 'template/backend', $this->data);
	...
	public function edit_user($id)
	{
		...
		$this->data['email'] = array(
			'name' => 'email',
			'id'   => 'email',
			'value' => $this->form_validation->set_value('phone', $user->email),
			'type' => 'email',
			'class' => 'form-control'
		);
		$this->data['password'] = array(
		...
		$this->data['page'] = $this->config->item('template') . 'auth/edit_user';
		$this->load->view($this->config->item('template') . 'template/backend', $this->data);
