...
class Users extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $data['page'] = $this->config->item('template') . 'users/list';
    ...
    public function read($id)
    {
        ...
        if ($row) {
            ...
            $data['page'] = $this->config->item('template') . 'users/users_read';
            $this->load->view($this->config->item('template') . 'template/backend', $data);
        } else {
    ...
    public function create()
    {
        ...
        $data['page'] = $this->config->item('template') . 'users/users_form';
        $this->load->view($this->config->item('template') . 'template/backend', $data);
    }
    ...
    public function printdoc()
    {
        ...
        $this->load->view($this->config->item('template') . 'users/users_print', $data);
    }
