...
class Groups extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $data['page'] = $this->config->item('template') . 'groups/groups_list';
    ...
    public function read($id)
    {
        ...
        if ($row) {
            ...
            $data['page'] = $this->config->item('template') . 'groups/groups_read';
            $this->load->view($this->config->item('template') . 'template/backend', $data);
        } else {
    ...
    public function create()
    {
        ...
        $data['page'] = $this->config->item('template') . 'groups/groups_form';
        $this->load->view($this->config->item('template') . 'template/backend', $data);
    }
    ...
    public function printdoc()
    {
        ...
        $this->load->view($this->config->item('template') . 'groups/groups_print', $data);
    }
    ...
    public function word()
    {
        ...
        $this->load->view($this->config->item('template') . 'groups/groups_doc', $data);
    }
}
