 ...
 */
$config['site_title']                 = "muhakbar.com";       // Site Title, example.com
$config['admin_email']                = "admin@muhakbar.com"; // Admin Email, admin@example.com
$config['default_group']              = 'mahasiswa';           // Default group, use name
$config['admin_group']                = 'kaprodi';             // Default administrators group, use name
// $config['admin_group']                = 'HCD';             // Default administrators group, use name
...
$config['identity_cookie_name'] = 'email';
